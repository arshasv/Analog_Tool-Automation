...
let expected_iout = iref_actual * {self.mirror_ratio}
let mirror_error = (expected_iout != 0) ? (iout_actual - expected_iout) / expected_iout * 100 : 0

echo ""
echo "Reference Current (M1): $&iref_actual A"
echo "Output Current (M2):    $&iout_actual A"
echo "Expected Iout:          $&expected_iout A"
echo "Mirror Error:           $&mirror_error %"
echo ""

* Calculate output resistance
let rout = 1/@m.x{self.m2.name}.msky130_fd_pr__nfet_01v8[gds]
